...
ifneq ($(XDC_CFG_FILE_$(CORE)),)
  ...
  TEMP_XDC_CFG_FILE = $(XDC_CFG_FILE_$(CORE))
  XDC_CFG_FILE_TEMP_$(CORE) = $(subst ../,,$(TEMP_XDC_CFG_FILE))
  
  CFG_CFILE_XDC =$(patsubst %.cfg,%_$(CFG_CFILENAMEPART_XDC).c,$(XDC_CFG_FILE_TEMP_$(CORE)))
...
$(CORE) : $(OBJDIR) $(BINDIR) $(DEPDIR) $(CONFIGURO_DIR) $(PKG_LIST) $(BINDIR)/omtb_$(APP_NAME)_$(CORE).$(EXEEXT)
